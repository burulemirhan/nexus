...
export const LanguageProvider: React.FC<LanguageProviderProps> = ({ children, defaultLanguage }) => {
  ...
  const translations: Record<Language, Record<string, string>> = {
    tr: {
      ...
      'tech.ai.title': 'Tüm ortamlarda mahsulleri yöneten birleşik bir AI katmanı',
      'tech.ai.module1': 'Mahsul Durum Zekası',
      'tech.ai.module2': 'Ortam Çevirisi',
      'tech.ai.module3': 'Kaynak Tahsisi',
      'tech.ai.module4': 'Sürekli Optimizasyon',
      ...
      'tech.terra.details': 'OTONOM HASAT // UYDU ANALİZİ',
    ...
    en: {
      ...
      'tech.ai.title': 'A unified AI layer operating crops across environments',
      'tech.ai.module1': 'Crop State Intelligence',
      'tech.ai.module2': 'Environment Translation',
      'tech.ai.module3': 'Resource Allocation',
      'tech.ai.module4': 'Continuous Optimization',
      'tech.oasis.name': 'OASIS',
      ...
      'tech.terra.details': 'AUTONOMOUS HARVEST // SATELLITE ANALYSIS',
